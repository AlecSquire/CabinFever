<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="bg-zinc-900 font-sans">
<head>
...
<div class="min-h-screen bg-zinc-900">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden ml-4 md:block">
                        <div class="flex items-baseline space-x-4">
                            ...
                            <x-nav href="/cabins" :active="request()->is('cabins')">Browse Cabins</x-nav>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="pt-4 pb-3 border-t border-gray-700">
                {{-- <div class="flex items-center px-5"> --}}
                    {{-- <img class="w-20 h-20" src="{{ asset('images/LOGO.png') }}" alt="Your Company">
                    <div class="ml-3"> --}}
    ...
    <main>
        <div class="max-w-full py-6 mx-auto bg-white sm:px-6 lg:px-8">
