                    ...
                    <div class="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b">
                        <div class="px-4">
                            <div class="border-b pb-4 border-gray-400 border-dashed">
                                ...
                                <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Cabin owners Zoom meeting
                                <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Discussion on new policy around room cleaning and customer deposits</p>
                            </div>
